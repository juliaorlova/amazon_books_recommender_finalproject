...
# убрал NA
```{r}
metaFood4<-na.omit(metaFood3)
```
# Объединение
```{r message = F, warning=FALSE}
all_table<-inner_join (reviewFood, metaFood4, by='asin')
```
...
sapply(all_table, class)
as.list(all_table, related)
all_table=select(all_table,-related)
